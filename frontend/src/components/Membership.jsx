      ...
      <main className="membership-content">
        <section className="membership-header">
          ...
          <p className="membership-subtitle">
            Unlock your fitness potential with the perfect plan for your goals
          </p>
                  ...
                  {plan.features.map((feature, featureIndex) => (
                    ...
                    >
                      {feature.included ? (
                        <Check
                          size={18}
                          className="feature-icon feature-check"
                        />
                      ) : (
          ...
          <div className="faq-content">
            ...
            <div className="faq-grid">
              ...
              <div className="faq-item">
                ...
                <p className="faq-answer">
                  We offer a 7-day free trial for new members on any plan. You
        ...
        <section className="membership-cta">
          <div className="cta-content">
            ...
            <p className="cta-description">
              Our support team is here to help you find the best plan for your
              fitness journey.
            </p>
